document.addEventListener('DOMContentLoaded', () => {
    const calculator = {
        ...
        init() {
            ...
            this.loadColorPreference(); // ✅ 색상 초기화
            ...
            try {
                ...
                if (/^[0-9\.\+\-\×\÷\(\)]*$/.test(cleanValue)) {
                    ...
                    try {
                        ...
                        this.mainDisplay.value = value; // 파싱 실패 시 원래 값 유지
                    }
                }
            } catch (error) {
        ...
        calculate() {
            try {
                ...
                // 숫자 뒤에 바로 괄호가 오는 경우 곱셈 연산자 삽입 (5(2) -> 5*(2))_25.04.08
        ...
        changeCalculatorColor(color) {
            ...
            localStorage.setItem('calculatorColor', color); // 선택한 색상을 저장
